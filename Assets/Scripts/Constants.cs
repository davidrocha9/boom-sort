...
public static class Constants
{
    ...
    public static float MIN_X = -6.4f;
    public static float MIN_Y = 23.2f;
    public static float MAX_X = 6.4f;
    public static float MAX_Y = 3.8f;
    public static float UNIT = 3.3f;
}